...
- 문제 발생시 유사도 추론을 통해 문제 상황과 가장 유사한 사례(해결책)를 제시
#### 장점
- XAI → 가장 유사한 과거 사례
- No Hallucination
- 성능 향상 → 코드 변경이나 학습 과정 없이 사례만 추가
#### 적용 분야
- 전문가 노하우 공유 → 의료/헬스케어, MRO(유지보수정비) 등
- 개인 맞춤형 추천 →  사용자 취향에 최적인 상품, 정보 추천
#### CBR 솔루션
- CBR 서버 → 유사도추론, 사례추가/제거 기능을 웹API로 제공
- 응용분야별 CBR 모델링 및 사례베이스 구축
#### [AI/CBR 소개자료](/ai-intro-v7.1.pdf)
#### [AI/CBR Key Concepts](/ai-intro-v7.1-key.pdf)
